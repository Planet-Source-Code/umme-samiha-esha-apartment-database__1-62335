...
Begin VB.Form frmcustomer 
   ...
   Begin VB.Frame fraInfo 
      ...
      Begin VB.ComboBox cboState 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmmem.frx":030A
         Left            =   3840
         List            =   "frmmem.frx":03A7
   ...
   Begin VB.Frame fraExpire 
      ...
      Begin VB.ComboBox cboGym_date 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmmem.frx":0478
         Left            =   2640
         List            =   "frmmem.frx":048B
         Style           =   2  'Dropdown List
         TabIndex        =   10
         Top             =   240
         Width           =   975
      ...
      Begin VB.ComboBox cboTan_date 
         ...
         ForeColor       =   &H00000000&
         Height          =   300
         ItemData        =   "frmmem.frx":04B7
         Left            =   2640
         List            =   "frmmem.frx":04CA
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   600
         Width           =   975
