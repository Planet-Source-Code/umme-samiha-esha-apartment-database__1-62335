...
Begin VB.Form frmmark 
   BackColor       =   &H80000007&
   Caption         =   "Employees of Marketing Department"
   ClientHeight    =   6495
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7680
   LinkTopic       =   "Form2"
   ScaleHeight     =   7065.268
   ScaleMode       =   0  'User
   ScaleWidth      =   7680
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frmmark.frx":0000
      OLEDBString     =   $"frmmark.frx":00F3
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "marketing"
      Caption         =   "Adodc1"
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         End
      End
      Begin VB.CommandButton cmdmenu17 
         Caption         =   "&Back"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
